...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="1125" valign="top"><table width="900" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="729" height="30"> <h3> <i class="fa fa-users"></i> Productos / Editor</h3></td>
            <td width="175" align="right"> <button type="button" onclick="window.location.href='productos.php';" class="btngris" style="border:0px; cursor:pointer;"> <i class="fa fa-arrow-left"></i> Volver </button> </td>
          </tr>
          <tr>
            <td height="30" colspan="2"><table width="900" border="0" cellpadding="1" cellspacing="1">
                  ...
                  <td height="30"><form id="form1" name="form1" method="post" action="<?php if($xestado=='modifica'){echo 'include/producto/prg_producto-modifica.php';}else{echo 'include/producto/prg_producto-nuevo.php';}?>">
                    <table width="900" border="0" cellpadding="1" cellspacing="1">
                      <tbody>
                        ...
                        <tr>
                          <td width="193" height="30"><span class="textoContenido">Cantidad</span></td>
                          <td width="195" height="30"><span class="textoContenido">Cantidad Mínima</span></td>
                          <td height="30"><span class="textoContenido">Precio</span></td>
                          <td height="30"><span class="textoContenido">Precio de Venta</span></td>
                        </tr>
                        <tr>
                          <td height="30"><input name="txtcantidad" type="text" class="textbox"  onKeyPress="return soloNumero(event)" value="<?php echo $xpFila['3'];?>" maxlength="5"></td>
                          <td height="30"><input name="txtcantidadminima" type="text" class="textbox" id="txtcantidadminima"  onKeyPress="return soloNumero(event)" value="<?php echo $xpFila['4'];?>" maxlength="5"></td>
                          <td height="30" valign="top"><input name="txtprecio" type="text" class="textbox" id="txtprecio" value="<?php echo $xpFila['5'];?>" style="text-align:right;"></td>
                          <td height="30" valign="top"><input name="txtprecioventa" type="text" class="textbox" id="textfield9" value="<?php echo $xpFila['6'];?>" style="text-align:right;"></td>
                        </tr>
                        <tr>
                          <td height="25" colspan="4"><span class="textoContenido">Descripción</span></td>
                        </tr>
                        <tr>
                          <td height="25" colspan="4"><textarea name="txtdescripcion" id="txtdescripcion" class="textbox" style="width:98%;"><?php echo $xpFila['7'];?></textarea></td>
                        </tr>
                        <tr>
                          <td height="25">&nbsp;</td>
                          <td height="25">&nbsp;</td>
